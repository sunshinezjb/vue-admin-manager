      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-aqua"
                @click="statAll(0)"><i class="ion ion-ios-people-outline"></i></span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-red"
                @click="statAll(1)"><i class="ion ion-android-person-add"></i></span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-green"
                @click="statAll(7)"><i class="fa fa-bar-chart"></i></span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-yellow"
                @click="statAll(30)"><i class="fa fa-area-chart"></i></span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-light-blue"
                @click="statAll(190)"><i class="ion ion-ios-people-outline"></i></span>
          <div class="info-box-content">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-blue"
                @click="statAll(11)"><i class="ion-android-people"></i></span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-teal"
                @click="statAll(17)"><i class="ion ion-arrow-graph-up-right"></i></span>
          <div class="info-box-content">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          <span class="info-box-icon bg-olive"
                @click="statAll(130)"><i class="fa fa-industry"></i></span>
          <div class="info-box-content">
